...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        [self setUpToolBar];
        self.isIntextfield = YES;
    }
    return self;
}

- (void)setIsIntextfield:(BOOL)isIntextfield {
    _isIntextfield = isIntextfield;
    if (isIntextfield) {
...
//    pickView.backgroundColor=[UIColor lightGrayColor];
    pickView.backgroundColor = TOOL_BACK_COLOR;
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.backgroundColor= TOOL_BACK_COLOR;
    if (_defaulDate) {
